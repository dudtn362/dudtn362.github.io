				...
				<div class="text-center">
					...
					<form method="post"
						...
						<table align="center">
							...
							<tr>
								<td nowrap width="200"><p align="right">비밀번호</td>
								<td width="400"><input type="password" name="pwd"
									value="${memInfo.pwd}"></td>
							</tr>
							<tr>
								<td nowrap width="400"><p align="right">이름</td>
								<td nowrap width="400"><input type="text" name="name"
							...
							<tr>
								<td nowrap width="400"><p align="right">가입일</td>
								<td nowrap width="400"><input type="text" name="joinDate"
							...
							<tr align="center">
								...
								<td colspan="2" width="400"><input type="submit"
									value="수정하기"> <input type="reset" value="다시입력">
								</td>
							</tr>
						</table>
					</form>
